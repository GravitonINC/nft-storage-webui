  ...
  render () {
    ...
    return (
      <DefinitionList>
        ...
        <Definition term={t('terms.ui')} desc={<a href={'https://github.com/ipfs-shipyard/ipfs-webui/releases/tag/v' + process.env.REACT_APP_VERSION} className='link purple robotomono f7' target='_blank' rel='noopener noreferrer'>v{process.env.REACT_APP_VERSION}</a>} />
      </DefinitionList>
    )
  }
}
